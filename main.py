...
# Convert to big endian byte array - call as instance method
data = conv.floatToBytes(True, f)
...
# Convert to little endian byte array - call as static method
...
# convert to big endian data to float - call as instance method
f = conv.bytesToFloat(True, datain)
...
# convert to big endian data to float - call as static method
